...
- **シューズタブ** — シューズ/ジェム/その他の3セグメント。カードグリッド→詳細(4隅ジェムソケット・属性バー・レベルアップ/リペア実装)。ジェムはギャラリー+魔法陣の強化合成(3個→Lv+1、成功率制)
...
- ミント/売却/フュージョン/転送、スクロール/バッジは「準備中」
