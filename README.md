...
- **フュージョン**: ベース靴+生贄1足(レアリティ不問・ベースより上位の靴も生贄にできる)。生贄が上回る属性のみ [現在値以上 到達上限以下] の範囲内でランダム数値に底上げされる。到達上限は**ベースのレアリティ帯の上限**で頭打ち(例: ベースがレアなら、生贄がエピックで41.5を持っていてもレア帯の上限28で止まる)
