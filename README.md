...
- **シューズタブ** — シューズ/ジェム/その他の3セグメント。カードグリッド→詳細(4隅ジェムソケット・属性バー)。**レベルアップ/リペア/ミント/フュージョン/売却が機能実装**。ジェムはギャラリー+魔法陣の強化合成(3個→Lv+1、成功率制)
...
- **フュージョン**: 同レアリティ5足+SP/GPを合成(成功で1段上、失敗でも同レアリティの靴)。レジェンダリー以外が対象
