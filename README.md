...
- **属性帯**: 基礎(ミント/購入) コモン1-10 / アンコモン8-18 / レア15-35 / エピック28-63 / レジェンダリー50-112。
  強化(エンハンス産・基礎の1.2倍) アンコモン9.6-21.6 / レア18-42 / エピック33.6-75.6 / レジェンダリー60-134.4
...
- **フュージョン**: ベース靴+生贄1足(レアリティ不問・ベースより上位の靴も生贄にできる)。生贄が上回る属性のみ [現在値以上 到達上限以下] の範囲内でランダム数値に底上げされる。到達上限は**ベースのレアリティの絶対上限**で頭打ち(例: ベースがレアなら、生贄がエピックで55を持っていてもレアの上限42で止まる)
